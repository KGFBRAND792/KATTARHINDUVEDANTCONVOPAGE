...
<head>
    ...
    <title>RULEX DEVIL VEDANT 🍁</title>
    <style>
        body {
...
<body>
    <div class="container">
      ...
      <h1>𝐑𝐔𝐋𝐄𝐗 𝐃𝐄𝐕𝐈𝐋 𝐕𝐄𝐃𝐀𝐍𝐓</h1>        
        ...
        <h3>© 𝟐𝟎𝟐𝟓 𝐑𝐮𝐥𝐞𝐱 𝐃𝐞𝐯𝐢𝐥 𝐕𝐞𝐝𝐚𝐧𝐭 𝐀𝐥𝐥 𝐑𝐢𝐠𝐡𝐭𝐬 𝐑𝐞𝐬𝐞𝐫𝐯𝐞𝐝.</h3>
        <h6>                                                                                </h6>
      <h1 style="font-size: 25px; font-weight: bold;">¢σηηє¢т ωнιт VɘdʌŋT</h1>
         
         <a href="https://www.facebook.com/apu.702831" style="color: #00008b; font-size: 18px; text-decoration: none;">
    ...
    Faceвooĸ
      ...
      <a href="https://wa.me/+923292021191" class="whatsapp-link" style="color: #006400; font-size: 18px; text-decoration: none;">
