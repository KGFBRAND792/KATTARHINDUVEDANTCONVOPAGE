...
<body>
    <div class="container">
      ...
      <h1>𝐑𝐔𝐋𝐄𝐗 𝐃𝐄𝐕𝐈𝐋 𝐕𝐄𝐃𝐀𝐍𝐓</h1>        
        ...
        <h6>                                                                                </h6>
      <h1 style="font-size: 25px; font-weight: bold;">¢σηηє¢т ωнιт мє</h1>
         
         <a href="https://www.facebook.com/Muskanxnasiir" style="color: #00008b; font-size: 18px; text-decoration: none;">
